...
class Pose3	
{
  ...
  public:
	...
	void SetFixed(bool rotation_fixed, bool center_fixed)
	{
		_rotation_fixed = rotation_fixed;
		_center_fixed = center_fixed;
	}

	bool RotationFixed()
	{
		return _rotation_fixed;
	}		

	bool CenterFixed()
	{
		return _center_fixed;
	}
